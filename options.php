...
$main_options = array(
    ...
    'DATE_END_FIELD_ID' => array('desc' => Loc::getMessage('TRAVELSOFT_AMO_DATE_END_FIELD_ID'), 'type' => 'text'),
    'ADULTS_FIELD_ID' => array('desc' => Loc::getMessage('TRAVELSOFT_AMO_ADULTS_FIELD_ID'), 'type' => 'text'),
    'TOTAL_PEOPLE_FIELD_ID' => array('desc' => Loc::getMessage('TRAVELSOFT_AMO_TOTAL_PEOPLE_FIELD_ID'), 'type' => 'text'),
    'BUS_SEAT_FIELD_ID' => array('desc' => Loc::getMessage('TRAVELSOFT_AMO_BUS_SEAT_FIELD_ID'), 'type' => 'text'),
    'ACCOMMODATION_TYPE_FIELD_ID' => array('desc' => Loc::getMessage('TRAVELSOFT_AMO_ACCOMMODATION_TYPE_FIELD_ID'), 'type' => 'text'),
    'ORDER_NUMBER_FIELD_ID' => array('desc' => Loc::getMessage('TRAVELSOFT_AMO_ORDER_NUMBER_FIELD_ID'), 'type' => 'text'),
