...
- Создавать контакт и привязывать его к сделке
- Создавать сделки по заявкам из инфоблока через очередь задач и cron
- Заполнять кастомные поля сделки: тур, даты, количество, места, тип размещения, номер заявки, ссылка на страницу тура

Настройки:

- ID инфоблока заявок
- ID полей сделки (тур, дата, дата окончания, кол-во взрослых/детей, общее кол-во, места, тип размещения, номер заявки, ссылка на страницу тура)
